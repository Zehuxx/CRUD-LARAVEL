...
class UsuarioStoreRequest extends FormRequest
{
	...
	public function rules()
	{
		...
		'cedula'=>'required|unique:users,cedula|max:11',
		'telefono'=>'nullable|numeric|unique:users,celular|digits_between:8,10',
		'pais'=>'exists:countries,id',
		'estado'=>'exists:estates,id',
		'ciudad'=>'exists:cities,id',
		'fecha_nacimiento'=> 'required|before:'.$newtime,
		'email'=>'required|max:35|email|unique:users,email|regex:/(^[a-zA-Z]{1}[a-zA-Z.]*[A-zA-Z0-9]+@{1}[a-zA-Z]{1}[a-zA-Z.]*[a-zA-Z]{1}$)/u',
